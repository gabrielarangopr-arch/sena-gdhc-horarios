    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-2xs overflow-hidden transition-colors">
            <div className="p-4 bg-slate-50/70 dark:bg-slate-800/60 border-b border-slate-200/80 dark:border-slate-800 flex flex-wrap items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-xl bg-emerald-100 dark:bg-emerald-950/60 text-[#39A900] flex items-center justify-center">
              ...
              <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/50 px-3 py-1 rounded-full border border-emerald-200 dark:border-emerald-800/60">
            ...
            {instructorHorarios.length === 0 ? (
              <div className="p-16 text-center text-slate-400 dark:text-slate-500">
                ...
                <p className="text-sm font-semibold text-slate-700 dark:text-slate-200">No tienes clases asignadas actualmente.</p>
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-center justify-between text-xs mb-1.5">
                                  ...
                                  <span className="font-mono font-bold text-slate-600 dark:text-slate-300 text-[10px] bg-slate-200/70 dark:bg-slate-700/80 px-1.5 py-0.5 rounded">
        ...
        <div className="lg:col-span-4 xl:col-span-3 space-y-4 no-print">
          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-2xs transition-colors">
            <div className="flex items-center gap-3.5">
              ...
              <div className="min-w-0">
                <span className="text-[10px] font-bold text-emerald-800 dark:text-emerald-300 bg-emerald-100 dark:bg-emerald-950/60 px-2 py-0.5 rounded-full inline-block mb-1 border border-emerald-200 dark:border-emerald-800/60">
                  INSTRUCTOR
                </span>
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 space-y-2 text-xs text-slate-600 dark:text-slate-300">
              <div className="flex items-center justify-between">
                <span className="text-slate-400 dark:text-slate-500">Especialidad:</span>
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 dark:from-slate-900 dark:to-slate-950 border border-slate-800 text-white p-5 rounded-2xl shadow-sm space-y-4">
            <div className="flex items-center justify-between">
          ...
          {uniqueFichas.length > 0 && (
            <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-2xs space-y-3 transition-colors">
              <h3 className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
                Mis Fichas de Formación
              </h3>
              <div className="space-y-2">
                {uniqueFichas.map(f => (
                  <div key={f.id} className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700/80 text-xs">
                    <div className="font-bold text-slate-900 dark:text-white">Ficha {f.codigo_ficha}</div>
                    <div className="text-slate-500 dark:text-slate-400 text-[11px] line-clamp-1">{f.nombre_programa}</div>
                    <div className="text-[10px] text-slate-400 dark:text-slate-500 mt-0.5">Jornada: {f.jornada}</div>
                  </div>
                ))}
              </div>
            </div>
