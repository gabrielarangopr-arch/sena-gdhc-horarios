...
export const NotificationPopover: React.FC<NotificationPopoverProps> = ({
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-3 top-20 sm:absolute sm:top-full sm:mt-2 sm:right-0 sm:inset-x-auto w-auto sm:w-96 max-w-[calc(100vw-1.5rem)] bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 z-50 animate-in fade-in zoom-in-95 flex flex-col max-h-[80vh] overflow-hidden">
        {/* Header */}
        ...
        <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between text-xs bg-white dark:bg-slate-900 shrink-0">
        ...
        {/* Footer Info */}
        <div className="p-2 bg-slate-50 dark:bg-slate-800/80 border-t border-slate-200 dark:border-slate-800 text-[10px] text-center text-slate-400 dark:text-slate-500 shrink-0">
